                                                                ...
                                                                field?.loading ? (
                                                                    ...
                                                                    <div>
                                                                        <select
                                                                            ...
                                                                            required
                                                                            disabled={isReadOnly || field?.readonly}
                                                                            className="w-full px-3 py-2  bg-gray-400 text-black rounded-sm outline-none placeholder:text-black"
                                                                        >
                                                                            {field.options &&
                                                                    ...
                                                                    <Select
                                                                        ...
                                                                        onChange={(selectedOptions) => {
                                                                            ...
                                                                            if (alloption && selectedOptions.length > 1) {
                                                                                if (selectedOptions[selectedOptions.length - 1].value === 'All') {
                                                                                    setFieldValue(field.name, [alloption])
                                                                                } else {
                                                                                    setFieldValue(field.name, selectedOptions.filter((option) => option.value !== 'All'))
                                                                                }
                                                                            } else {
                                                                        ...
                                                                        onBlur={handleBlur}
                                                                        placeholder={field?.placeholder}
                                                                        isDisabled={isReadOnly || field?.readonly}
                                                                        className="bg-gray-400 text-black rounded-sm focus:outline-none placeholder:text-black"
                                                                    />
